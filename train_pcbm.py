...
def run_linear_probe(args, train_data, test_data, num_classes):
    ...
    for lbl in np.unique(train_labels):
        ...
        cls_precision["test"][lbl] = precision_score(test_labels[test_lbl_mask], test_predictions[test_lbl_mask], zero_division=0)
        cls_precision["train"][lbl] = precision_score(train_labels[train_lbl_mask], train_predictions[train_lbl_mask], zero_division=0)
