...
def load_coco_stuff_data(args, biased_classes, num_test_samples_per_class=500, num_val_samples_per_class=250):
    ...
    train_dataset = foz.load_zoo_dataset("coco-2017", split="train", label_types=["detections"], classes=biased_classes)
    val_dataset = foz.load_zoo_dataset("coco-2017", split="validation", label_types=["detections"], classes=biased_classes)
